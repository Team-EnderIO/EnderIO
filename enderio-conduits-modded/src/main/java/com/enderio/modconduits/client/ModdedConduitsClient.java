...
public class ModdedConduitsClient {
    ...
    private static final Map<String, Supplier<ConduitClientModule>> CLIENT_MODULES = Map.ofEntries(
        Map.entry(ModuleModIds.MEKANISM, () -> MekanismClientModule.INSTANCE)
    );

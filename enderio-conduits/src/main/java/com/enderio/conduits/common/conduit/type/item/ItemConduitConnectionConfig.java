...
public record ItemConduitConnectionConfig(
    ...
    RedstoneControl insertRedstoneControl,
    DyeColor insertRedstoneChannel,
    ...
    public static final ItemConduitConnectionConfig DEFAULT = new ItemConduitConnectionConfig(false, DyeColor.GREEN, true,
            DyeColor.GREEN, RedstoneControl.NEVER_ACTIVE, DyeColor.RED, RedstoneControl.ALWAYS_ACTIVE, DyeColor.RED, false, false, 0);
    ...
    public static final MapCodec<ItemConduitConnectionConfig> CODEC = RecordCodecBuilder.mapCodec(instance -> instance
            .group(Codec.BOOL.fieldOf("is_insert").forGetter(ItemConduitConnectionConfig::isInsert),
                    ...
                    RedstoneControl.CODEC.optionalFieldOf("insert_redstone_control", RedstoneControl.ALWAYS_ACTIVE)
                            .forGetter(ItemConduitConnectionConfig::extractRedstoneControl),
                    DyeColor.CODEC.optionalFieldOf("insert_redstone_channel", DyeColor.RED)
                            .forGetter(ItemConduitConnectionConfig::insertRedstoneChannel),
    ...
    public static final StreamCodec<ByteBuf, ItemConduitConnectionConfig> STREAM_CODEC = MassiveStreamCodec.composite(
        ByteBufCodecs.BOOL,
        ItemConduitConnectionConfig::isInsert,
        DyeColor.STREAM_CODEC,
        ItemConduitConnectionConfig::insertChannel,
        ByteBufCodecs.BOOL,
        ItemConduitConnectionConfig::isExtract,
        DyeColor.STREAM_CODEC,
        ItemConduitConnectionConfig::extractChannel,
        RedstoneControl.STREAM_CODEC,
        ItemConduitConnectionConfig::extractRedstoneControl,
        DyeColor.STREAM_CODEC,
        ItemConduitConnectionConfig::extractRedstoneChannel,
        RedstoneControl.STREAM_CODEC,
        ItemConduitConnectionConfig::insertRedstoneControl,
        DyeColor.STREAM_CODEC,
        ItemConduitConnectionConfig::insertRedstoneChannel,
        ByteBufCodecs.BOOL,
        ItemConduitConnectionConfig::isRoundRobin,
        ByteBufCodecs.BOOL,
        ItemConduitConnectionConfig::isSelfFeed,
        ByteBufCodecs.INT,
        ItemConduitConnectionConfig::priority,
        ItemConduitConnectionConfig::new);
    // @formatter:on
    ...
    public ConnectionConfig reconnected() {
        return new ItemConduitConnectionConfig(false, insertChannel, true, extractChannel, extractRedstoneControl,
                extractRedstoneChannel, insertRedstoneControl, insertRedstoneChannel, isRoundRobin, isSelfFeed, priority);
    }
    ...
    public boolean canInsert(ConduitRedstoneSignalAware signalAware) {
        ...
        if (insertRedstoneControl.isRedstoneSensitive()) {
            return insertRedstoneControl.isActive(signalAware.hasRedstoneSignal(insertRedstoneChannel));
        } else {
            return insertRedstoneControl == RedstoneControl.ALWAYS_ACTIVE;
        }
    }
    ...
    public ItemConduitConnectionConfig withIsInsert(boolean isInsert) {
        return new ItemConduitConnectionConfig(isInsert, insertChannel, isExtract, extractChannel,
                extractRedstoneControl, extractRedstoneChannel, insertRedstoneControl, insertRedstoneChannel, isRoundRobin, isSelfFeed, priority);
    }
    ...
    public ItemConduitConnectionConfig withInsertRedstoneControl(RedstoneControl insertRedstoneControl) {
        return new ItemConduitConnectionConfig(isInsert, insertChannel, isExtract, extractChannel,
                extractRedstoneControl, extractRedstoneChannel, insertRedstoneControl, insertRedstoneChannel, isRoundRobin, isSelfFeed, priority);
    }

    public ItemConduitConnectionConfig withInsertRedstoneChannel(DyeColor insertRedstoneChannel) {
        return new ItemConduitConnectionConfig(isInsert, insertChannel, isExtract, extractChannel,
                extractRedstoneControl, extractRedstoneChannel, insertRedstoneControl, insertRedstoneChannel, isRoundRobin, isSelfFeed, priority);
    }
    ...
    public ItemConduitConnectionConfig withPriority(int priority) {
        return new ItemConduitConnectionConfig(isInsert, insertChannel, isExtract, extractChannel,
                extractRedstoneControl, extractRedstoneChannel, insertRedstoneControl, insertRedstoneChannel, isRoundRobin, isSelfFeed,

...
public final class ItemConduitNodeData implements NodeData {
    ...
    public static MapCodec<ItemConduitNodeData> CODEC = RecordCodecBuilder.mapCodec(instance -> instance
        .group(Codec.unboundedMap(Direction.CODEC, Codec.INT).fieldOf("round_robin_indexes").forGetter(i -> i.roundRobinIndexes))
        .apply(instance, ItemConduitNodeData::new));

    public static NodeDataType<ItemConduitNodeData> TYPE = new NodeDataType<>(ItemConduitNodeData.CODEC, ItemConduitNodeData::new);

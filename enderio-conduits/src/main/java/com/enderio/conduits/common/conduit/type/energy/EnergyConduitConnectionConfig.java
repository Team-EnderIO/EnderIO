...
public record EnergyConduitConnectionConfig(
    ...
    public static MapCodec<EnergyConduitConnectionConfig> CODEC = RecordCodecBuilder.mapCodec(
        instance -> instance.group(
            Codec.BOOL.fieldOf("can_insert").forGetter(EnergyConduitConnectionConfig::canInsert),
            Codec.BOOL.fieldOf("can_extract").forGetter(EnergyConduitConnectionConfig::canExtract),
            RedstoneControl.CODEC.fieldOf("redstone_control").forGetter(EnergyConduitConnectionConfig::redstoneControl),
            DyeColor.CODEC.fieldOf("redstone_channel").forGetter(EnergyConduitConnectionConfig::redstoneChannel)

...
public class NewConduitSelectionButton extends AbstractButton {
    ...
    public NewConduitSelectionButton(int pX, int pY, int conduitButtonIndex, Supplier<Holder<Conduit<?, ?>>> currentConduit,
        Supplier<List<Holder<Conduit<?, ?>>>> conduitListGetter, Consumer<Integer> onPressed) {

...
public record ConduitConnection(ConduitConnectionMode mode, DyeColor inputChannel, DyeColor outputChannel,
        RedstoneControl redstoneControl, DyeColor redstoneChannel) {

    public static Codec<ConduitConnection> CODEC = RecordCodecBuilder
            .create(instance -> instance
                    .group(ConduitConnectionMode.CODEC.fieldOf("mode").forGetter(ConduitConnection::mode),
                            ...
                            RedstoneControl.CODEC.fieldOf("redstone_control")
                                    .forGetter(ConduitConnection::redstoneControl),
    ...
    public static StreamCodec<ByteBuf, ConduitConnection> STREAM_CODEC = StreamCodec.composite(
            ConduitConnectionMode.STREAM_CODEC, ConduitConnection::mode, DyeColor.STREAM_CODEC,
            ConduitConnection::inputChannel, DyeColor.STREAM_CODEC, ConduitConnection::outputChannel,
            RedstoneControl.STREAM_CODEC, ConduitConnection::redstoneControl, DyeColor.STREAM_CODEC,
            ConduitConnection::redstoneChannel, ConduitConnection::new);

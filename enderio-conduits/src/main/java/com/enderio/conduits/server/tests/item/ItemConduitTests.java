...
public class ItemConduitTests {
            ...
            helper.startSequence()
                ...
                .thenExecute(() -> helper
                    ...
                    .setConnectionConfig(itemConduit, Direction.NORTH,
                        ItemConduitConnectionConfig.DEFAULT.withIsReceive(true).withIsSend(false).withReceiveRedstoneControl(RedstoneControl.NEVER_ACTIVE)))
                // Configure the insert end
                .thenExecute(() -> helper
                    .getConduitBundle(0, 1, 1, false)
                    .setConnectionConfig(itemConduit, Direction.SOUTH, ItemConduitConnectionConfig.DEFAULT.withIsReceive(false).withIsSend(true)))
                ...
                .thenExecute(() -> helper
                    .getConduitBundle(0, 1, 1, false)
                    .setConnectionConfig(itemConduit, Direction.NORTH,
                        ItemConduitConnectionConfig.DEFAULT.withIsReceive(true).withIsSend(false).withReceiveRedstoneControl(RedstoneControl.ALWAYS_ACTIVE)))
    ...
    public static void itemConduitDistancePriority(final ItemConduitGameTestHelper helper) {
        ...
        helper.startSequence()
            ...
            .thenExecute(() -> helper
                ...
                .setConnectionConfig(itemConduit, Direction.EAST, ItemConduitConnectionConfig.DEFAULT.withIsReceive(false).withIsSend(true)))
            .thenExecute(() -> helper
                .getConduitBundle(1, 1, 2, false)
                .setConnectionConfig(itemConduit, Direction.WEST, ItemConduitConnectionConfig.DEFAULT.withIsReceive(false).withIsSend(true)))
            // Configure the extract end
            .thenExecute(() -> helper
    ...
    public static void itemConduitManualPriority(final ItemConduitGameTestHelper helper) {
        ...
        helper.startSequence()
            ...
            .thenExecute(() -> helper
                .getConduitBundle(1, 1, 2, false)
                .setConnectionConfig(itemConduit, Direction.WEST, ItemConduitConnectionConfig.DEFAULT.withIsReceive(false).withIsSend(true).withPriority(2)))
            // Configure the extract end
            .thenExecute(() -> helper
                .getConduitBundle(1, 1, 0, false)
                .setConnectionConfig(itemConduit, Direction.EAST,
    ...
    public static void itemConduitRoundRobin(final ItemConduitGameTestHelper helper) {
        ...
        helper.startSequence()
            ...
            // Put some dirt in the chest we'll extract from, 2x transfer rate of our conduit so we can follow two network ticks.
            .thenExecute(() -> helper.insertIntoContainer(2, 1, 0, Items.DIRT, transferRate * 2))
            // Ensure the max transfer amount reaches the closest chest first, then the second chest

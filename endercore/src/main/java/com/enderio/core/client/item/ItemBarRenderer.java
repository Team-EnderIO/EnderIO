...
public class ItemBarRenderer {
    ...
    public static void renderBar(GuiGraphicsExtractor graphics, float fillRatio, int xOffset, int yOffset, int color) {
...
//        RenderSystem.disableBlend();
        ...
        // TODO: 1.21.8. GuiGraphicsExtractor does this for damage bars. Do we copy?
        //int i = x + 2;
        //int j = y + 13;

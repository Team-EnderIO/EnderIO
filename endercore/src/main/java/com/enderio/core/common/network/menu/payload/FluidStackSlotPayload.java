...
public record FluidStackSlotPayload(FluidStack value) implements SlotPayload {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, FluidStackSlotPayload> STREAM_CODEC =
        FluidStack.STREAM_CODEC.map(FluidStackSlotPayload::new, FluidStackSlotPayload::value);

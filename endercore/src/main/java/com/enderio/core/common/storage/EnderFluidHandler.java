...
public class EnderFluidHandler<TOwner> extends EnderStacksResourceHandler<FluidResource, FluidStack, TOwner> implements ValueIOSerializable {
    public EnderFluidHandler(ResourceStorageLayout<FluidResource, TOwner> layout, TOwner context) {

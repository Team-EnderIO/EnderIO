...
public class EIOBlockEntities {
    ...
    public static final DeferredBlockEntityType<SinglePaintedBlockEntity> SINGLE_PAINTED = BLOCK_ENTITIES
    ...
    public static final DeferredBlockEntityType<DoublePaintedBlockEntity> DOUBLE_PAINTED = BLOCK_ENTITIES
        .create("double_painted", DoublePaintedBlockEntity::new, EIOBlocks.PAINTED_SLAB).finish();

    public static final DeferredBlockEntityType<PoweredLightBlockEntity> POWERED_LIGHT = BLOCK_ENTITIES
    ...
    public static final DeferredBlockEntityType<LightNodeBlockEntity> LIGHT_NODE = BLOCK_ENTITIES
        .create("light_node", LightNodeBlockEntity::new, EIOBlocks.LIGHT_NODE).finish();

    public static final DeferredBlockEntityType<EnderSkullBlockEntity> ENDER_SKULL = BLOCK_ENTITIES

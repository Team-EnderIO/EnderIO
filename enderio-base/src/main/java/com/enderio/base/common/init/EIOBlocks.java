...
import com.enderio.base.datagen.block.PaintBlockState;
import com.enderio.base.datagen.loot.PaintLootTable;
...
public class EIOBlocks {
    ...
    public static final BlockEntry<PaintedSlabBlock> PAINTED_SLAB = REGISTRATE
        ...
        .blockstate((ctx, cons) -> PaintBlockState.paintedBlock(ctx, cons, Blocks.OAK_SLAB))
        .addLayer(() -> RenderType::translucent)
        .initialProperties(() -> Blocks.OAK_SLAB)
        .loot(PaintLootTable::paintedSlab)
    ...
    private static <T extends Block> BlockEntry<T> paintedBlock(String name, NonNullFunction<BlockBehaviour.Properties, T> blockFactory, Block copyFrom,
        ...
        BlockEntry<T> paintedBlockEntry = REGISTRATE
            ...
            .blockstate((ctx, cons) -> PaintBlockState.paintedBlock(ctx, cons, copyFrom))
            .addLayer(() -> RenderType::translucent)
            .loot(PaintLootTable::withPaint)

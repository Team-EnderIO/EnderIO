...
public class EIOFluids {
    ...
    public static final DeferredFluidType<FluidType> LIQUID_SUNSHINE =
    ...
    public static final DeferredFluidType<FluidType> CLOUD_SEED =
        fluid("cloud_seed", "Cloud Seed", FluidType.Properties.create().density(500).viscosity(800)).finish();

    public static final DeferredFluidType<FluidType> CLOUD_SEED_CONCENTRATED =

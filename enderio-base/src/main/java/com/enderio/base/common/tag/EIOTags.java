...
public class EIOTags {
    ...
    public static class Blocks {
        ...
        public static final IOptionalNamedTag<Block> DARK_STEEL_EXPLODABLE_STONE = BlockTags.createOptional(EnderIO.loc("dark_steel_explodable_stone"));
        public static final IOptionalNamedTag<Block> DARK_STEEL_EXPLODABLE_DIRT = BlockTags.createOptional(EnderIO.loc("dark_steel_explodable_dirt"));

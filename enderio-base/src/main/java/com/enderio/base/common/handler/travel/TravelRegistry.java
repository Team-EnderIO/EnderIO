...
public class TravelRegistry {
    ...
    @API
    public static record TravelEntry<T extends ITravelTarget>(ResourceLocation serializationName, Function<CompoundTag, T> constructor, Lazy<TeleportationRenderer<T>> renderer) {}
}

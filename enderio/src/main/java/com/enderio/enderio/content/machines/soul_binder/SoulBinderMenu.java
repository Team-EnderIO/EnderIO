...
public class SoulBinderMenu extends PoweredMachineMenu<SoulBinderBlockEntity> {
    ...
    private void addSlots() {
        ...
        addSlot(new MachineSlot(getMachineInventory(), SoulBinderBlockEntity.OUTPUTS.slot(0), 112, 34));
        addSlot(new MachineSlot(getMachineInventory(), SoulBinderBlockEntity.OUTPUTS.slot(1), 134, 34));

...
public class NewRedstoneConduitTicker extends ConduitTickerBase<RedstoneConduit> {

    public static final NewRedstoneConduitTicker INSTANCE = new NewRedstoneConduitTicker();

    private NewRedstoneConduitTicker() {}

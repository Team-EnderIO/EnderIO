...
public class EIOCapabilities {
    ...
    public static final class SideConfig {
        public static final BlockCapability<com.enderio.enderio.api.capability.SideConfig, Direction> BLOCK = BlockCapability
                .createSided(EnderIO.loc("side_config"), com.enderio.enderio.api.capability.SideConfig.class);
    }

...
public class EngineSoul {
    ...
    public record SoulData(ResourceLocation entitytype, String fluid, int powerpermb, int tickpermb) implements com.enderio.enderio.common.foundation.souldata.SoulData {
        @Override

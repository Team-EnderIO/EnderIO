package com.enderio.enderio.common.foundation.souldata;
...
public class SolarSoul {
    ...
    public record SoulData(ResourceLocation entitytype, boolean daytime, boolean nighttime, Optional<ResourceKey<Level>> level) implements com.enderio.enderio.common.foundation.souldata.SoulData {

...
public class EIOLang {
    ...
    public static final MutableComponent CAPACITOR_TOOLTIP_BASE = addTranslation("tooltip",
            EnderIO.rl("capacitor.base"), "Base Modifier: %s");

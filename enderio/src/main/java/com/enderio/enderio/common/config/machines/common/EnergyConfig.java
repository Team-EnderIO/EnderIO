package com.enderio.enderio.common.config.machines.common;
...
public class EnergyConfig {
    ...
    public final ModConfigSpec.ConfigValue<Integer> NIARD_CAPACITY;
    public final ModConfigSpec.ConfigValue<Integer> NIARD_USAGE;

...
public class EnergyConfig {
    public final ModConfigSpec.IntValue ALLOY_SMELTER_CAPACITY;
    public final ModConfigSpec.IntValue ALLOY_SMELTER_USAGE;
    public final ModConfigSpec.IntValue ALLOY_SMELTER_VANILLA_ITEM_ENERGY;
    public final ModConfigSpec.IntValue CRAFTER_CAPACITY;
    public final ModConfigSpec.IntValue CRAFTER_USAGE;
    public final ModConfigSpec.IntValue CRAFTING_RECIPE_COST;
    public final ModConfigSpec.IntValue IMPULSE_HOPPER_CAPACITY;
    public final ModConfigSpec.IntValue IMPULSE_HOPPER_USAGE;
    public final ModConfigSpec.IntValue POWERED_SPAWNER_CAPACITY;
    public final ModConfigSpec.IntValue POWERED_SPAWNER_USAGE;
    public final ModConfigSpec.IntValue SAG_MILL_CAPACITY;
    public final ModConfigSpec.IntValue SAG_MILL_USAGE;
    public final ModConfigSpec.IntValue SLICER_CAPACITY;
    public final ModConfigSpec.IntValue SLICER_USAGE;
    public final ModConfigSpec.IntValue SOUL_BINDER_CAPACITY;
    public final ModConfigSpec.IntValue SOUL_BINDER_USAGE;
    public final ModConfigSpec.IntValue STIRLING_GENERATOR_CAPACITY;
    public final ModConfigSpec.DoubleValue STIRLING_GENERATOR_BURN_SPEED;
    public final ModConfigSpec.IntValue STIRLING_GENERATOR_FUEL_EFFICIENCY_BASE;
    public final ModConfigSpec.IntValue STIRLING_GENERATOR_FUEL_EFFICIENCY_STEP;
    ...
    public final ModConfigSpec.IntValue BASIC_CAPACITOR_BANK_CAPACITY;
    public final ModConfigSpec.IntValue ADVANCED_CAPACITOR_BANK_CAPACITY;
    public final ModConfigSpec.IntValue VIBRANT_CAPACITOR_BANK_CAPACITY;
    public final ModConfigSpec.IntValue WIRED_CHARGER_CAPACITY;
    public final ModConfigSpec.IntValue WIRED_CHARGER_USAGE;
    public final ModConfigSpec.IntValue WIRELESS_CHARGER_CAPACITY;
    public final ModConfigSpec.IntValue WIRELESS_CHARGER_USAGE;
    public final ModConfigSpec.IntValue WIRELESS_CHARGER_UPKEEP;
    public final ModConfigSpec.IntValue SOUL_ENGINE_CAPACITY;
    public final ModConfigSpec.IntValue SOUL_ENGINE_BURN_SPEED;
    public final ModConfigSpec.DoubleValue SOUL_ENGINE_GENERATION;
    public final ModConfigSpec.IntValue DRAIN_CAPACITY;
    public final ModConfigSpec.IntValue DRAIN_USAGE;
    public final ModConfigSpec.IntValue NIARD_CAPACITY;
    public final ModConfigSpec.IntValue NIARD_USAGE;
    public final ModConfigSpec.IntValue FARM_CAPACITY;
    public final ModConfigSpec.IntValue FARM_USAGE;
    public final ModConfigSpec.IntValue INHIBITOR_CAPACITY;
    public final ModConfigSpec.IntValue INHIBITOR_USAGE;
    public final ModConfigSpec.IntValue AVERSION_CAPACITY;
    public final ModConfigSpec.IntValue AVERSION_USAGE;
    public final ModConfigSpec.IntValue RELOCATOR_CAPACITY;
    public final ModConfigSpec.IntValue RELOCATOR_USAGE;
    public final ModConfigSpec.IntValue ATTRACTOR_CAPACITY;
    public final ModConfigSpec.IntValue ATTRACTOR_USAGE;
    ...
    public EnergyConfig(ModConfigSpec.Builder builder) {
        ...
        builder.push("niard");
        NIARD_CAPACITY = builder.comment("The base energy capacity in uI.")
            .defineInRange("capacity", 64_000, 1, Integer.MAX_VALUE);
        NIARD_USAGE = builder.comment("The base energy consumption in uI/t.")
            .defineInRange("usage", 10, 1, Integer.MAX_VALUE);
        builder.pop();

...
public class EnergyConfig {
    ...
    public final ForgeConfigSpec.ConfigValue<Integer> WIRELESS_CHARGER_CAPACITY;
    public final ForgeConfigSpec.ConfigValue<Integer> WIRELESS_CHARGER_USAGE;
    public final ForgeConfigSpec.ConfigValue<Integer> WIRELESS_CHARGER_UPKEEP;
    ...
    public final ForgeConfigSpec.ConfigValue<Integer> NIARD_CAPACITY;
    public final ForgeConfigSpec.ConfigValue<Integer> NIARD_USAGE;
    ...
    public final ForgeConfigSpec.ConfigValue<Integer> INHIBITOR_CAPACITY;
    public final ForgeConfigSpec.ConfigValue<Integer> INHIBITOR_USAGE;
    public final ForgeConfigSpec.ConfigValue<Integer> AVERSION_CAPACITY;
    public final ForgeConfigSpec.ConfigValue<Integer> AVERSION_USAGE;
    public final ForgeConfigSpec.ConfigValue<Integer> RELOCATOR_CAPACITY;
    public final ForgeConfigSpec.ConfigValue<Integer> RELOCATOR_USAGE;
    public final ForgeConfigSpec.ConfigValue<Integer> ATTRACTOR_CAPACITY;
    public final ForgeConfigSpec.ConfigValue<Integer> ATTRACTOR_USAGE;

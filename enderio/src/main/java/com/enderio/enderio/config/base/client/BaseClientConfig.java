...
public class BaseClientConfig {
    ...
    public final ModConfigSpec.ConfigValue<Integer> TRAVEL_KEY_HOLD_DELAY;

    public BaseClientConfig(ModConfigSpec.Builder builder) {
        builder.push("behavior");
        TRAVEL_KEY_HOLD_DELAY = builder.comment("Ticks before Staff Of Traveling Keybind is considered 'held' for anchor teleports ").define("travelKeyHoldDelayTicks", 8);
        builder.pop();
        builder.push("visual");

...
public class EIOLootModifiers {
    private static final DeferredRegister<MapCodec<? extends IGlobalLootModifier>> SERIALIZERS = DeferredRegister
            .create(ForgeRegistries.GLOBAL_LOOT_MODIFIER_SERIALIZERS, EnderIO.MOD_ID);
    ...
    // public static RegistryObject<// MapCodec<AutoSmeltModifier>> AUTO_SMELT =
    // SERIALIZERS.register("auto_smelt", () -> AutoSmeltModifier.CODEC);

    public static RegistryObject<MapCodec<BrokenSpawnerLootModifier>> BROKEN_SPAWNER_SERIALIZER = SERIALIZERS
            .register("broken_spawner", () -> BrokenSpawnerLootModifier.CODEC);

    public static final RegistryObject<LootItemFunctionType> SET_LOOT_CAPACITOR = FUNCTIONS
            .register("set_loot_capacitor", () -> new LootItemFunctionType(SetLootCapacitorFunction.CODEC));

    public static final RegistryObject<LootItemFunctionType> COPY_PAINT = FUNCTIONS

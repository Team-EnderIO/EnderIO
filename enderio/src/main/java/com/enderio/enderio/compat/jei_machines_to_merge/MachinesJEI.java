...
public class MachinesJEI implements IModPlugin {
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        ...
        registration.addCraftingStation(EnchanterCategory.TYPE, new ItemStack(EIOBlocks.ENCHANTER.get()));
        registration.addCraftingStation(SagMillCategory.TYPE, new ItemStack(EIOBlocks.SAG_MILL.get()));
        registration.addCraftingStation(SlicingRecipeCategory.TYPE, new ItemStack(EIOBlocks.SLICE_AND_SPLICE.get()));
        registration.addCraftingStation(SoulBindingCategory.TYPE, new ItemStack(EIOBlocks.SOUL_BINDER.get()));
        registration.addCraftingStation(TankCategory.TYPE, new ItemStack(EIOBlocks.FLUID_TANK.get()));
        registration.addCraftingStation(TankCategory.TYPE, new ItemStack(EIOBlocks.PRESSURIZED_FLUID_TANK.get()));
        registration.addCraftingStation(SoulEngineCategory.TYPE, new ItemStack(EIOBlocks.SOUL_ENGINE.get()));
        registration.addCraftingStation(VATCategory.TYPE, new ItemStack(EIOBlocks.VAT.get()));
        registration.addCraftingStation(WeatherChangeCategory.TYPE, new ItemStack(EIOBlocks.WEATHER_OBELISK.get()));
    }

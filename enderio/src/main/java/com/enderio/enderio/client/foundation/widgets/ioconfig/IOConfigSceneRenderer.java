...
/**
 * 26.2-port: stub placeholder. The original implementation depended on the removed
 * {@code MultiBufferSource} API. The IOConfig widget is disabled until the 26.2
 * submit-node-based render pipeline is implemented.
 */
public class IOConfigSceneRenderer {
    // no-op
}

...
public class EIOCommonWidgets {
    private static final ResourceLocation ICON_RANGE_ENABLE = EnderIO.rl("icon/range_enable");
    private static final ResourceLocation ICON_RANGE_DISABLE = EnderIO.rl("icon/range_disable");

    private static final ResourceLocation PLUS = EnderIO.rl("buttons/plus_small");
    private static final ResourceLocation MINUS = EnderIO.rl("buttons/minus_small");

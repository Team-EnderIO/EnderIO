...
import com.enderio.enderio.machines.client.gui.widget.FluidStackStaticWidget;
...
public class XPVacuumScreen extends MachineScreen<XPVacuumMenu> {
    ...
    private static final ResourceLocation XP_VACUUM_BG = EnderIOAPI.loc("textures/gui/screen/xp_vacuum.png");

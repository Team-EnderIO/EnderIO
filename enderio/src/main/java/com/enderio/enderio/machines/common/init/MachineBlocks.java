...
import com.enderio.enderio.machines.common.blocks.block_detector.BlockDetectorBlock;
import com.enderio.enderio.machines.common.blocks.enchanter.EnchanterBlock;
import com.enderio.enderio.machines.common.blocks.enderface.EnderfaceBlock;
import com.enderio.enderio.machines.common.blocks.fluid_tank.FluidTankBlock;
import com.enderio.enderio.machines.common.blocks.fluid_tank.FluidTankBlockItem;
import com.enderio.enderio.machines.common.blocks.niard.NiardBlock;
...
import com.enderio.enderio.machines.common.blocks.powered_spawner.MindKillerBlock;
...
import com.enderio.enderio.machines.common.blocks.travel_anchor.PaintedTravelAnchorBlock;
import com.enderio.enderio.machines.common.blocks.travel_anchor.TravelAnchorBlock;
...
public class MachineBlocks {
            ...
            .setBlockStateProvider((prov, ctx) -> prov.horizontalBlock(ctx.get(), prov.models()
                    ...
                    .child("tank",
                            ModelHelper.getExistingAsBuilder(prov.models(),
                                    EnderIOAPI.loc(String.format("block/%s_body", ctx.getName()))))
                    .child("overlay", ModelHelper.getExistingAsBuilder(prov.models(), EnderIOAPI.loc("block/io_overlay")))
                    .end()
                    .texture("particle", EnderIOAPI.loc("block/machine_side"))))
    ...
    public static final RegiliteBlock<EnderfaceBlock> ENDERFACE = BLOCK_REGISTRY
            ...
            .setBlockStateProvider((prov, ctx) -> prov.simpleBlock(ctx.get(),
                    prov.models().cubeAll("enderface", EnderIOAPI.loc("block/enderface")).renderType("translucent")))
            .createBlockItem(ITEM_REGISTRY, item -> item.setTab(EIOCreativeTabs.MACHINES));
    ...
    public static final RegiliteBlock<BlockDetectorBlock> BLOCK_DETECTOR = BLOCK_REGISTRY
            ...
            .setBlockStateProvider((prov, ctx) -> prov.models().getExistingFile(EnderIOAPI.loc("block/" + ctx.getName())))
            .createBlockItem(ITEM_REGISTRY, item -> item.setTab((EIOCreativeTabs.MACHINES)));
    ...
    private static RegiliteBlock<CapacitorBankBlock> capacitorBank(String name,
        ...
        return BLOCK_REGISTRY
                .registerBlock(name, props -> new CapacitorBankBlock(props, RegiliteBlockEntity.get(), tier),
                        BlockBehaviour.Properties.of().strength(2.5f, 8))
                .setBlockStateProvider((prov, ctx) -> prov.simpleBlock(ctx.get(),
                        prov.models().getExistingFile(EnderIOAPI.loc(ctx.getName()))))
                .setLootTable(MachinesLootTable::copyComponents)
                .addBlockTags(BlockTags.MINEABLE_WITH_PICKAXE)

        ...
        test.onGameTest(EnderGameTestHelper.class, helper -> {
            helper.startSequence()
                ...
                .thenExecute(() -> {
                    ...
                    var detectorState = helper.getBlockState(new BlockPos(1, 0, 0));
                    ...
                    // Verify lamp is lit
                    var lampState = helper.getBlockState(new BlockPos(3, 0, 0));
                ...
                .thenExecute(() -> helper.setBlock(new BlockPos(0, 0, 0), Blocks.AIR))

    ...
    public static void itemConduitRoundRobin(final ConduitGameTestHelper helper) {
        ...
        helper.startSequence()
            ...
            .thenExecuteAfter(tickRate, () -> {
                helper.assertContainerHasExactly(2, 0, 2, Items.DIRT, transferRate);
                helper.assertContainerEmpty(0, 0, 2);
            })
            .thenExecuteAfter(tickRate, () -> {
                helper.assertContainerHasExactly(2, 0, 2, Items.DIRT, transferRate);
                 helper.assertContainerHasExactly(0, 0, 2, Items.DIRT, transferRate);
            })
            // Place an item into the first chest
            .thenSucceed();
    }

    ...
    public static void testAlloySmelterAlloyingRecipe(final DynamicTest test) {
        ...
        test.onGameTest(EnderGameTestHelper.class, helper -> {
            helper.startSequence()
                ...
                .thenExecute(() -> {
                    helper.insertIntoContainer(0, 0, 0, Items.IRON_INGOT, 1);
                    helper.insertIntoContainer(0, 0, 0, Items.COAL, 2);
                    helper.insertIntoContainer(0, 0, 0, Items.OBSIDIAN, 1);
                })
                // Wait for the recipe to process
                .thenExecuteAfter(20, () -> {
                    // Verify inputs have been extracted
                    helper.assertContainerHasExactly(0, 0, 0, Items.IRON_INGOT, 0);
    ...
    public static void testAlloySmelterVanillaSmeltingRecipe(final DynamicTest test) {
        ...
        test.onGameTest(EnderGameTestHelper.class, helper -> {
            helper.startSequence()
                ...
                .thenExecute(() -> helper.insertIntoContainer(0, 0, 0, Items.RAW_IRON, 3))
                // Wait for processing
                .thenExecuteAfter(20, () -> {
                    // Verify input was consumed
                    helper.assertContainerHasExactly(0, 0, 0, Items.RAW_IRON, 0);

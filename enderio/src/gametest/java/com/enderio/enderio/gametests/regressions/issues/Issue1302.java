    ...
    public static void testIssue1302(final DynamicTest test) {
        ...
        test.onGameTest(EnderGameTestHelper.class, helper -> {
            helper.startSequence()
                ...
                .thenExecute(() -> helper.insertIntoContainer(0, 0, 0, Items.WET_SPONGE, 3))
                ...
                .thenExecuteAfter(20, () -> {
                    ...
                    helper.assertContainerHasExactly(0, 0, 0, net.minecraft.world.level.material.Fluids.WATER, 3000);
                })
                .thenSucceed();
        });
    }

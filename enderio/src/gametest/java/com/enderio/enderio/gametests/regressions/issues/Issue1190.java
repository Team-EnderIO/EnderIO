        ...
        test.onGameTest(ConduitGameTestHelper.class, helper -> {
            ...
            helper.startSequence()
                ...
                .thenExecute(() -> {
                    ...
                    helper.placeConduit(redstoneConduit, 1, 1, 1);
                    // (1,1,2) connects to BROWN redstone block
                    helper.placeConduit(redstoneConduit, 1, 1, 2);
                    // (2,1,1) middle conduit
                    helper.placeConduit(redstoneConduit, 2, 1, 1);
                    // (3,1,1) connects to lamp
                    helper.placeConduit(redstoneConduit, 3, 1, 1);
                })
                ...
                .thenExecute(() -> {
                    var bundle = helper.getConduitBundle(3, 1, 1, false);
                ...
                .thenExecuteAfter(tickRate * 3, () -> {
                    var lampState = helper.getBlockState(new BlockPos(4, 1, 1));

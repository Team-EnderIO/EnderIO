...
//                .save(recipeOutput, EnderIO.id("vibrant_capacitor_bank_upgrade"));
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.FLUID_TANK.get())
                ...
                .unlockedBy("has_ingredient",
                        InventoryChangeTrigger.TriggerInstance
                                .hasItems(ItemPredicate.Builder.item().of(items, Tags.Items.INGOTS_IRON).build()))
                .save(recipeOutput);

        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.PRESSURIZED_FLUID_TANK.get())
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.ENCHANTER.get())
                .define('B', Items.BOOK)
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.ALLOY_SMELTER.get())
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.STIRLING_GENERATOR.get())
                .define('F', Blocks.FURNACE)
                .define('I', Tags.Items.INGOTS_IRON)
                .define('G', EIOTags.Items.GEARS_IRON)
                .define('V', EIOBlocks.VOID_CHASSIS.get())
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.SLICE_AND_SPLICE.get())
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.SOUL_BINDER.get())
                .define('I', EIOTags.Items.INGOTS_SOULARIUM)
                .define('C', EIOBlocks.ENSOULED_CHASSIS.get())
                .define('G', EIOTags.Items.GEARS_ENERGIZED)
        ...
        ShapedEntityStorageRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.POWERED_SPAWNER)
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.SOUL_ENGINE)
                .define('I', EIOTags.Items.INGOTS_SOULARIUM) // TODO Maybe also soulchains?
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.VACUUM_CHEST.get())
                .define('I', Tags.Items.INGOTS_IRON)
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.DRAIN.get())
                ...
                .unlockedBy("has_ingredient",
                        InventoryChangeTrigger.TriggerInstance
                                .hasItems(ItemPredicate.Builder.item().of(items, EIOBlocks.VOID_CHASSIS).build()))
                .save(recipeOutput);

        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.NIARD.get())
            .define('P', Items.PISTON)
            .define('B', Items.BUCKET)
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.XP_VACUUM)
                .pattern("III")
                .pattern("IRI")
                .pattern("IPI")
                .define('I', Tags.Items.INGOTS_IRON)
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.CRAFTER.get())
                .define('I', Tags.Items.INGOTS_IRON)
                .define('G', EIOTags.Items.GEARS_IRON)
                .define('C', EIOBlocks.VOID_CHASSIS.get())
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.TRAVEL_ANCHOR.get())
                .define('I', Tags.Items.INGOTS_IRON)
                ...
                .unlockedBy("has_ingredient",
                        InventoryChangeTrigger.TriggerInstance
                                .hasItems(ItemPredicate.Builder.item().of(items, EIOItems.PULSATING_CRYSTAL).build()))
                .save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.AVERSION_OBELISK.get())
                ...
                .unlockedBy("has_ingredient",
                        InventoryChangeTrigger.TriggerInstance
                                .hasItems(ItemPredicate.Builder.item().of(items, EIOBlocks.ENDERMAN_HEAD).build()))
                .save(recipeOutput);

        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.INHIBITOR_OBELISK.get())
                ...
                .unlockedBy("has_ingredient",
                        InventoryChangeTrigger.TriggerInstance
                                .hasItems(ItemPredicate.Builder.item().of(items, EIOItems.ENDER_CRYSTAL).build()))
                .save(recipeOutput);

        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.RELOCATOR_OBELISK.get())
                ...
                .unlockedBy("has_ingredient",
                        InventoryChangeTrigger.TriggerInstance
                                .hasItems(ItemPredicate.Builder.item().of(items, EIOBlocks.AVERSION_OBELISK).build()))
                .save(recipeOutput);

        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.ATTRACTOR_OBELISK.get())
                ...
                .unlockedBy("has_ingredient",
                        InventoryChangeTrigger.TriggerInstance
                                .hasItems(ItemPredicate.Builder.item().of(items, EIOItems.ENTICING_CRYSTAL).build()))
                .save(recipeOutput);

        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.WEATHER_OBELISK.get())
                ...
                .unlockedBy("has_ingredient",
                        InventoryChangeTrigger.TriggerInstance
                                .hasItems(ItemPredicate.Builder.item().of(items, EIOItems.WEATHER_CRYSTAL).build()))
                .save(recipeOutput);

        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.VAT.get())
                ...
                .unlockedBy("has_ingredient",
                        InventoryChangeTrigger.TriggerInstance
                                .hasItems(ItemPredicate.Builder.item().of(items, Blocks.BARREL).build()))
                .save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.MIND_KILLER.get())
            .define('S', EIOTags.Items.INGOTS_SOULARIUM)
            .define('Z', EIOItems.ZOMBIE_ELECTRODE)
            .define('E', EIOTags.Items.INGOTS_ENERGETIC_ALLOY)
            .pattern(" Z ")
         ...
         */
        eraseRecipes(items, recipeOutput);
    }

...
public class MiscBlockRecipeProvider extends SubRecipeProvider {
    ...
    public void buildRecipes(HolderLookup.Provider registries, RecipeOutput recipeOutput) {
        ...
        addConstructionBlockRecipes(items, recipeOutput);
        buildChassisRecipes(items, recipeOutput);
    ...
    private void buildChassisRecipes(HolderLookup.RegistryLookup<Item> items, RecipeOutput recipeOutput) {
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, EIOBlocks.ENSOULED_CHASSIS.get())
    ...
    private void addConstructionBlockRecipes(HolderLookup.RegistryLookup<Item> items, RecipeOutput recipeOutput) {
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.BUILDING_BLOCKS, EIOBlocks.DARK_STEEL_BARS.get(), 16)
                .define('I', EIOTags.Items.INGOTS_DARK_STEEL)
                .pattern("III")
                .pattern("III")
                .unlockedBy("has_ingredient",
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.BUILDING_BLOCKS, EIOBlocks.DARK_STEEL_TRAPDOOR, 1)
                .define('I', EIOTags.Items.INGOTS_DARK_STEEL)
                .pattern("II")
                .pattern("II")
                .unlockedBy("has_ingredient",
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.BUILDING_BLOCKS, EIOBlocks.DARK_STEEL_DOOR, 3)
                .define('I', EIOTags.Items.INGOTS_DARK_STEEL)
                .pattern("II")
                .pattern("II")
                .pattern("II")
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.BUILDING_BLOCKS, EIOBlocks.END_STEEL_BARS, 12)
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.BUILDING_BLOCKS, EIOBlocks.REINFORCED_OBSIDIAN.get())
    ...
    private void addPressurePlateRecipes(HolderLookup.RegistryLookup<Item> items, RecipeOutput recipeOutput) {
        ...
        addSilentPressurePlateRecipe(items, recipeOutput, EIOBlocks.SILENT_DARK_STEEL_PRESSURE_PLATE,
                EIOBlocks.DARK_STEEL_PRESSURE_PLATE.get());
        addPressurePlateRecipe(items, recipeOutput, EIOBlocks.SOULARIUM_PRESSURE_PLATE, EIOTags.Items.INGOTS_SOULARIUM,
                EIOItems.SOULARIUM_INGOT);
        addSilentPressurePlateRecipe(items, recipeOutput, EIOBlocks.SILENT_SOULARIUM_PRESSURE_PLATE,
                EIOBlocks.SOULARIUM_PRESSURE_PLATE);
        // wooden silent plates
        addSilentPressurePlateRecipe(items, recipeOutput, EIOBlocks.SILENT_OAK_PRESSURE_PLATE, Blocks.OAK_PRESSURE_PLATE);
        addSilentPressurePlateRecipe(items, recipeOutput, EIOBlocks.SILENT_ACACIA_PRESSURE_PLATE,
                Blocks.ACACIA_PRESSURE_PLATE);
        addSilentPressurePlateRecipe(items, recipeOutput, EIOBlocks.SILENT_DARK_OAK_PRESSURE_PLATE,
                Blocks.DARK_OAK_PRESSURE_PLATE);
        addSilentPressurePlateRecipe(items, recipeOutput, EIOBlocks.SILENT_SPRUCE_PRESSURE_PLATE,
                Blocks.SPRUCE_PRESSURE_PLATE);
        addSilentPressurePlateRecipe(items, recipeOutput, EIOBlocks.SILENT_BIRCH_PRESSURE_PLATE, Blocks.BIRCH_PRESSURE_PLATE);
        addSilentPressurePlateRecipe(items, recipeOutput, EIOBlocks.SILENT_JUNGLE_PRESSURE_PLATE,
                Blocks.JUNGLE_PRESSURE_PLATE);
        addSilentPressurePlateRecipe(items, recipeOutput, EIOBlocks.SILENT_CRIMSON_PRESSURE_PLATE,
                Blocks.CRIMSON_PRESSURE_PLATE);
        addSilentPressurePlateRecipe(items, recipeOutput, EIOBlocks.SILENT_WARPED_PRESSURE_PLATE,
                Blocks.WARPED_PRESSURE_PLATE);
        // stone silent plates
        addSilentPressurePlateRecipe(items, recipeOutput, EIOBlocks.SILENT_STONE_PRESSURE_PLATE, Blocks.STONE_PRESSURE_PLATE);
        addSilentPressurePlateRecipe(items, recipeOutput, EIOBlocks.SILENT_POLISHED_BLACKSTONE_PRESSURE_PLATE,
                Blocks.POLISHED_BLACKSTONE_PRESSURE_PLATE);
        // wighted silent plates
        addSilentPressurePlateRecipe(items, recipeOutput, EIOBlocks.SILENT_HEAVY_WEIGHTED_PRESSURE_PLATE,
                Blocks.HEAVY_WEIGHTED_PRESSURE_PLATE);
        addSilentPressurePlateRecipe(items, recipeOutput, EIOBlocks.SILENT_LIGHT_WEIGHTED_PRESSURE_PLATE,
    ...
    private void addLeverRecipes(HolderLookup.RegistryLookup<Item> items, RecipeOutput recipeOutput) {
        ...
        addLeverRecipe(items, recipeOutput, EIOBlocks.RESETTING_LEVER_THIRTY, EIOBlocks.RESETTING_LEVER_THIRTY_INV,
                EIOBlocks.RESETTING_LEVER_TEN, EIOBlocks.RESETTING_LEVER_TEN_INV, 3);
        addLeverRecipe(items, recipeOutput, EIOBlocks.RESETTING_LEVER_SIXTY, EIOBlocks.RESETTING_LEVER_SIXTY_INV,
                EIOBlocks.RESETTING_LEVER_THIRTY, EIOBlocks.RESETTING_LEVER_THIRTY_INV, 4);
        addLeverRecipe(items, recipeOutput, EIOBlocks.RESETTING_LEVER_THREE_HUNDRED,
    ...
    private void addLeverRecipe(HolderLookup.RegistryLookup<Item> items, RecipeOutput recipeOutput, Supplier<? extends ResettingLeverBlock> base,
        ...
        // Main recipe.
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.REDSTONE, base.get())
                .requires(Blocks.LEVER)
                .requires(Ingredient.of(items.getOrThrow(Tags.Items.DUSTS_REDSTONE)), numRedstone)
        ...
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.REDSTONE, inverted.get())
                .requires(Blocks.LEVER)
                .requires(Ingredient.of(items.getOrThrow(Tags.Items.DUSTS_REDSTONE)), numRedstone)
                .requires(Blocks.REDSTONE_TORCH)
                .unlockedBy("has_ingredient", InventoryChangeTrigger.TriggerInstance.hasItems(Blocks.LEVER))

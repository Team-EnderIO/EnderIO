...
public interface DarkSteelUpgrade {// extends INBTSerializable<Tag> {
     ...
     */
    default Optional<? extends DarkSteelUpgrade> getNextTier() {
     ...
     */
    default Optional<? extends UpgradeTier> getTier() {
        return Optional.empty();
    }
     ...
     * @return res
     */
    default boolean isValidUpgrade(DarkSteelUpgrade upgrade) {
        return false;
    }

...
public interface ConduitNetworkContext<T extends ConduitNetworkContext<T>> {
     ...
     * @apiNote The result of this method does not need to be a new instance, unlike {@link #split(ConduitNetwork, Set)}.
     */
    T mergeWith(T other);
     ...
     */
    T split(ConduitNetwork selfNetwork, Set<? extends ConduitNetwork> allNetworks);

...
public class AlloyRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput recipeOutput) {
        ...
        build(new ItemStack(EIOItems.ENERGETIC_ALLOY_INGOT.get()),
            List.of(SizedIngredient.of(Tags.Items.DUSTS_REDSTONE, 1), SizedIngredient.of(Tags.Items.INGOTS_GOLD, 1),
                SizedIngredient.of(Tags.Items.DUSTS_GLOWSTONE, 1)), 4800, 0.3f, recipeOutput);
        build(new ItemStack(EIOItems.ELECTRICAL_STEEL_INGOT.get()),
            List.of(SizedIngredient.of(Tags.Items.INGOTS_IRON, 1), SizedIngredient.of(EIOTags.Items.DUSTS_COAL, 1),
                SizedIngredient.of(EIOTags.Items.SILICON, 1)), 3200, 0.3f, recipeOutput);
        build(new ItemStack(EIOItems.VIBRANT_ALLOY_INGOT.get()),
            List.of(SizedIngredient.of(EIOTags.Items.INGOTS_ENERGETIC_ALLOY, 1), SizedIngredient.of(Tags.Items.ENDER_PEARLS, 1)), 4800, 0.3f, recipeOutput);
        build(new ItemStack(EIOItems.REDSTONE_ALLOY_INGOT.get()),
            List.of(SizedIngredient.of(Tags.Items.DUSTS_REDSTONE, 1), SizedIngredient.of(EIOTags.Items.SILICON, 1)), 3200, 0.3f, recipeOutput);
        build(new ItemStack(EIOItems.CONDUCTIVE_ALLOY_INGOT.get()),
            List.of(SizedIngredient.of(Tags.Items.INGOTS_COPPER, 1), SizedIngredient.of(Tags.Items.DUSTS_REDSTONE, 1)), 3200, 0.3f, recipeOutput);
        build(new ItemStack(EIOItems.PULSATING_ALLOY_INGOT.get()),
            List.of(SizedIngredient.of(Tags.Items.INGOTS_IRON, 1), SizedIngredient.of(Tags.Items.ENDER_PEARLS, 1)), 4800, 0.3f, recipeOutput);
        build(EnderIO.loc("dark_steel_ingot_with_coal"),
            List.of(SizedIngredient.of(Tags.Items.INGOTS_IRON, 1), SizedIngredient.of(Items.COAL, 2), SizedIngredient.of(Tags.Items.OBSIDIANS, 1)),
            new ItemStack(EIOItems.DARK_STEEL_INGOT.get()), 6400, 0.3f, recipeOutput);
        build(new ItemStack(EIOItems.DARK_STEEL_INGOT.get()),
            List.of(SizedIngredient.of(Tags.Items.INGOTS_IRON, 1), SizedIngredient.of(EIOTags.Items.DUSTS_COAL, 1),
                SizedIngredient.of(Tags.Items.OBSIDIANS, 1)), 6400, 0.3f, recipeOutput);
        build(new ItemStack(EIOItems.SOULARIUM_INGOT.get()),
            List.of(new SizedIngredient(Ingredient.of(Items.SOUL_SAND, Items.SOUL_SOIL), 1), SizedIngredient.of(Tags.Items.INGOTS_GOLD, 1)), 5600, 0.3f,
            recipeOutput);
        build(new ItemStack(EIOItems.END_STEEL_INGOT.get()),
            List.of(SizedIngredient.of(Tags.Items.END_STONES, 1), SizedIngredient.of(EIOTags.Items.INGOTS_DARK_STEEL, 1),
                SizedIngredient.of(Tags.Items.OBSIDIANS, 1)), 6400, 0.3f, recipeOutput);

        // Steel compat
        var steelRecipeOutput = recipeOutput.withConditions(new NotCondition(new TagEmptyCondition(EIOTags.Items.INGOTS_STEEL)));
        build(new ItemStack(EIOItems.DARK_STEEL_INGOT.get()), "from_steel",
            List.of(SizedIngredient.of(EIOTags.Items.INGOTS_STEEL, 1), SizedIngredient.of(Tags.Items.OBSIDIANS, 1)), 6400, 0.3f, steelRecipeOutput);
        build(new ItemStack(EIOItems.ELECTRICAL_STEEL_INGOT.get()), "from_steel",
            List.of(SizedIngredient.of(EIOTags.Items.INGOTS_STEEL, 1), SizedIngredient.of(EIOTags.Items.SILICON, 1)), 3200, 0.3f, steelRecipeOutput);
        ...
        build(new ItemStack(EIOItems.DYE_GREEN.get()), "clippings",
            List.of(SizedIngredient.of(EIOItems.PLANT_MATTER_GREEN.get(), 6), SizedIngredient.of(Items.EGG, 1)), 1000, 0.3f, recipeOutput);
        build(new ItemStack(EIOItems.DYE_GREEN.get(), 2), "double_clippings",
            List.of(SizedIngredient.of(EIOItems.PLANT_MATTER_GREEN.get(), 12), SizedIngredient.of(Tags.Items.SLIMEBALLS, 1)), 1600, 0.3f, recipeOutput);

        build(new ItemStack(EIOItems.DYE_BROWN.get()), "twigs",
            List.of(SizedIngredient.of(EIOItems.PLANT_MATTER_BROWN.get(), 6), SizedIngredient.of(Items.EGG, 1)), 1000, 0.3f, recipeOutput);
        build(new ItemStack(EIOItems.DYE_BROWN.get(), 2), "twigs_double",
            List.of(SizedIngredient.of(EIOItems.PLANT_MATTER_BROWN.get(), 12), SizedIngredient.of(Tags.Items.SLIMEBALLS, 1)), 1600, 0.3f, recipeOutput);

        build(new ItemStack(EIOItems.DYE_BLACK.get()), List.of(SizedIngredient.of(EIOTags.Items.DUSTS_COAL, 1), SizedIngredient.of(Items.EGG, 1)), 1000, 0.3f,
            recipeOutput);
        build(new ItemStack(EIOItems.DYE_BLACK.get(), 2), "double",
            List.of(SizedIngredient.of(EIOTags.Items.DUSTS_COAL, 2), SizedIngredient.of(Tags.Items.SLIMEBALLS, 1)), 1600, 0.3f, recipeOutput);

        build(new ItemStack(Items.RED_DYE, 12),
            List.of(SizedIngredient.of(Items.BEETROOT, 1), SizedIngredient.of(Items.CLAY_BALL, 3), SizedIngredient.of(Items.EGG, 6)), 1600, 0.3f, recipeOutput);
        ...
        for (Map.Entry<GlassIdentifier, GlassBlocks> glassGroup : EIOBlocks.GLASS_BLOCKS.entrySet()) {
            ...
            if (identifier.collisionPredicate() == GlassCollisionPredicate.NONE) {
                ...
                var mainIngredient = identifier.explosion_resistance() ?
                    SizedIngredient.of(Tags.Items.GEMS_QUARTZ, 4) :
                    SizedIngredient.of(Tags.Items.GLASS_BLOCKS_COLORLESS, 1);
                @Nullable var altIngredient = identifier.explosion_resistance() ? SizedIngredient.of(EIOTags.Items.STORAGE_BLOCKS_QUARTZ, 1) : null;
        ...
        build(new ItemStack(EIOItems.NETHERCOTTA.get()),
            List.of(SizedIngredient.of(Tags.Items.BRICKS_NETHER, 1), SizedIngredient.of(Items.NETHER_WART, 4), SizedIngredient.of(Items.CLAY_BALL, 6)), 7600,
            0.3f, recipeOutput);

        build(new ItemStack(EIOItems.CAKE_BASE.get(), 2), List.of(SizedIngredient.of(EIOItems.FLOUR.get(), 3), SizedIngredient.of(Items.EGG, 1)), 2000, 0.3f,
            recipeOutput);

        build(new ItemStack(Items.COOKIE, 8), List.of(SizedIngredient.of(EIOItems.FLOUR.get(), 1), SizedIngredient.of(Items.COCOA_BEANS, 1)), 2000, 0.3f,
            recipeOutput);

        build(new ItemStack(EIOItems.PHOTOVOLTAIC_PLATE.get()), List.of(SizedIngredient.of(EIOItems.PHOTOVOLTAIC_COMPOSITE.get(), 3)), 5600, 0.3f,
            recipeOutput);
        ...
        build(new ItemStack(EIOItems.CLAYED_GLOWSTONE.get(), 2),
            List.of(SizedIngredient.of(Tags.Items.DUSTS_GLOWSTONE, 1), SizedIngredient.of(Items.CLAY_BALL, 1)), 3200, 0.3f, recipeOutput);
        ...
        build(new ItemStack(EIOBlocks.INDUSTRIAL_INSULATION.get()),
            List.of(SizedIngredient.of(EIOTags.Items.DUSTS_LAPIS, 1), SizedIngredient.of(ItemTags.WOOL, 1),
                SizedIngredient.of(EIOTags.Items.INSULATION_METAL, 1)), 3200, 0.5f, recipeOutput);
    ...
    protected void glass(FusedQuartzBlock block, SizedIngredient input, @Nullable SizedIngredient inputAlt, int energy, float experience,
    ...
    protected void compositeGlass(FusedQuartzBlock block, String suffix, SizedIngredient inputA, SizedIngredient inputB, SizedIngredient inputBAlt, int energy,
    ...
    protected void build(ItemStack output, String suffix, List<SizedIngredient> inputs, int energy, float experience, RecipeOutput recipeOutput) {
        build(EnderIO.loc("alloy_smelting/" + BuiltInRegistries.ITEM.getKey(output.getItem()).getPath() + "_" + suffix), inputs, output, energy, experience,
            recipeOutput);
    }

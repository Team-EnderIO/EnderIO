...
public class AlloyRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput recipeOutput) {
        ...
        build(EnderIOBase.loc("dark_steel_ingot_with_coal"), List.of(SizedIngredient.of(Tags.Items.INGOTS_IRON, 1), SizedIngredient.of(Items.COAL, 2), SizedIngredient.of(Tags.Items.OBSIDIANS, 1)), new ItemStack(EIOItems.DARK_STEEL_INGOT.get()), 6400, 0.3f, recipeOutput);

...
public class PoweredSpawnerBlockEntity extends PoweredMachineBlockEntity implements IOwnedSpawner, RangedActor {
    ...
    private static final ActionRange DEFAULT_RANGE = new ActionRange(ACTION_RANGE, false);
    ...
    public void loadAdditional(CompoundTag pTag, HolderLookup.Provider lookupProvider) {
        ...
        if (pTag.contains(MachineNBTKeys.ACTION_RANGE)) {

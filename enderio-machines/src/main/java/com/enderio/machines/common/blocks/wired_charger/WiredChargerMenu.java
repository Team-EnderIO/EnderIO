...
public class WiredChargerMenu extends PoweredMachineMenu<WiredChargerBlockEntity> {
    ...
    public WiredChargerMenu(int containerId, Inventory playerInventory, RegistryFriendlyByteBuf buf) {
        super(MachineMenus.WIRED_CHARGER.get(), MachineBlockEntities.WIRED_CHARGER.get(), containerId, playerInventory, buf);
        addSlots();
    ...
    private void addSlots() {
        ...
        //Add offhand slot
        addSlot(new Slot(getPlayerInventory(), 40, 6, 84)

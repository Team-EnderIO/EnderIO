...
public class KeyBinds {
    ...
    public static final Lazy<KeyMapping> GLIDER_MAPPING = Lazy
            .of(() -> new KeyMapping(ArmoryLang.DS_UPGRADE_GLIDER_KEYBIND, KeyConflictContext.IN_GAME,
                    InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_G, ArmoryLang.DS_UPGRADE_KEYBIND_CATEGORY));

    @SubscribeEvent
    public static void registerBindings(RegisterKeyMappingsEvent event) {
        event.register(GLIDER_MAPPING.get());
        NeoForge.EVENT_BUS.addListener(GliderUpgrade::toggleGliderUpgrade);
    }

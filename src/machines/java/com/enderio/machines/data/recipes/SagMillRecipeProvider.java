...
public class SagMillRecipeProvider extends EnderRecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput recipeOutput) {
        ...
        build1toN("iron", Tags.Items.INGOTS_IRON, POWDERED_IRON.get(), 1, recipeOutput);
        build1toN("gold", Tags.Items.INGOTS_GOLD, POWDERED_GOLD.get(), 1, recipeOutput);
        build1toN("obsidian", Tags.Items.OBSIDIAN, POWDERED_OBSIDIAN.get(), 4, recipeOutput);
        
        build1toN("precient_crystal", EIOTags.Items.GEMS_PRESCIENT_CRYSTAL, PRESCIENT_POWDER.get(), 1, recipeOutput);
        build1toN("vibrant_crystal", EIOTags.Items.GEMS_VIBRANT_CRYSTAL, VIBRANT_POWDER.get(), 1, recipeOutput);
        build1toN("pulsating_crystal", EIOTags.Items.GEMS_PULSATING_CRYSTAL, PULSATING_POWDER.get(), 1, recipeOutput);
        build1toN("ender_crystal", EIOTags.Items.GEMS_ENDER_CRYSTAL, ENDER_CRYSTAL_POWDER.get(), 1, recipeOutput);
        
        build1toN("ender_pearl", Tags.Items.ENDER_PEARLS, POWDERED_ENDER_PEARL.get(), 9, recipeOutput);
        build1toN("blaze_powder", Tags.Items.RODS_BLAZE, BLAZE_POWDER, 4, recipeOutput);
        build1toN("glass", Tags.Items.GLASS, SAND, 1, recipeOutput);
        build1toN("bone_block", BONE_BLOCK, BONE_MEAL, 9, recipeOutput);
        build1toN("soularium", EIOTags.Items.INGOTS_SOULARIUM, SOUL_POWDER.get(), 1, recipeOutput);
        ...
        build1toN("stone", Tags.Items.STONE, COBBLESTONE, 1, recipeOutput);
    ...
    private void build1toN(String name, Item input, Item output, int number, RecipeOutput recipeOutput) {

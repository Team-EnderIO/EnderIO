...
public class XPVacuumScreen extends EIOScreen<XPVacuumMenu> {
    ...
    protected void init() {
        ...
        addRenderableWidget(new Button(leftPos + imageWidth - 8 - 12 - 20 - 2, topPos + 50 - 5, 20, 9, Component.literal("\u2303"),
            (b) -> this.getMenu().getBlockEntity().increaseRange()));
        addRenderableWidget(new Button(leftPos + imageWidth - 8 - 12 - 20 - 2, topPos + 50 + 6, 20, 9, Component.literal("\u2304"),

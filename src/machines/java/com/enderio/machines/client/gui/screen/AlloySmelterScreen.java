...
public class AlloySmelterScreen extends EIOScreen<AlloySmelterMenu> {
    ...
    private static final ResourceLocation BG_TEXTURE_SIMPLE_ALLOY = EnderIO.loc("textures/gui/simple_alloy_smelter.png");
    private static final ResourceLocation BG_TEXTURE_SIMPLE_FURNACE = EnderIO.loc("textures/gui/simple_furnace.png");

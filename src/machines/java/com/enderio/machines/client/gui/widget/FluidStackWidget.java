            ...
            if (still != null) {
                ...
                if (texture instanceof TextureAtlas atlas) {
                    ...
                    for (int i = 0; i < Math.ceil(renderableHeight / 16f); i++) {
                        ...
                        blit(poseStack, x, y + notDrawingHeight, displayOn.getBlitOffset(), sprite.getU0()*atlasWidth, sprite.getV0()*atlasHeight + notDrawingHeight, width, drawingHeight, atlasWidth, atlasHeight);

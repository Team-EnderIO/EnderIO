...
public class RelocatorObeliskBER implements BlockEntityRenderer<RelocatorObeliskBlockEntity> {

    public RelocatorObeliskBER(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(RelocatorObeliskBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource buffer, int packedLight, int packedOverlay) {
        poseStack.pushPose();
        ...
        ItemStack stack = new ItemStack(Items.PRISMARINE);

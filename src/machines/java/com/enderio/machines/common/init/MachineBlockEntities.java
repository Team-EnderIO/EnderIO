...
public class MachineBlockEntities {
    ...
    public static final BlockEntityEntry<FarmingStationBlockEntity> FARMING_STATION = register("farming_station", FarmingStationBlockEntity::new, MachineBlocks.FARMING_STATION);

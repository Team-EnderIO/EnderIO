...
public class MachineMenus {
    ...
    public static final MenuEntry<ZombieGeneratorMenu> ZOMBIE_GENERATOR = REGISTRATE.menu("zombie_generator", ZombieGeneratorMenu::factory, () -> ZombieGeneratorScreen::new).register();

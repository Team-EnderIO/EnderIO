...
public class MachineRecipes {
    ...
    public static final RecipeTypeSerializerPair<SoulBindingRecipe, SoulBindingRecipe.Serializer> SOULBINDING = register("soulbinding", SoulBindingRecipe.Serializer::new);

...
import com.enderio.machines.common.recipe.VatReagentRecipe;
...
public class MachineRecipes {
    ...
    public static final RecipeTypeSerializerPair<VatReagentRecipe, VatReagentRecipe.Serializer> VAT_REAGENT = register("vat_reagent",
        VatReagentRecipe.Serializer::new);

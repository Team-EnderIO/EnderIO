...
public class MachineBlocks {
    ...
    public static final BlockEntry<MachineBlock> ENCHANTER = REGISTRATE
        ...
        .blockstate((ctx, prov) -> prov.horizontalBlock(ctx.get(), prov
            ...
            .customLoader(CompositeModelBuilder::begin)
            .child("plinth", EIOModel
                .getExistingParent(prov.models(), EnderIO.loc("block/dialing_device"))
                .texture("button", EnderIO.loc("block/dark_steel_pressure_plate")))
            .child("book", (BlockModelBuilder) EIOModel
                .getExistingParent(prov.models(), EnderIO.loc("block/enchanter_book"))
                .rootTransforms()
    ...
    public static final BlockEntry<ProgressMachineBlock> ALLOY_SMELTER = standardMachine("alloy_smelter", () -> MachineBlockEntities.ALLOY_SMELTER).register();

    public static final BlockEntry<ProgressMachineBlock> PAINTING_MACHINE = standardMachine("painting_machine",

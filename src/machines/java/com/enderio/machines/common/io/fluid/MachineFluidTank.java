...
public class MachineFluidTank extends FluidTank {
    ...
    public static final int DEFAULT_CAPACITY = 8 * FluidType.BUCKET_VOLUME;
    ...
    public MachineFluidTank(BlockEntity parent) {
        super(DEFAULT_CAPACITY, (FluidStack stack)->true);
        this.parent = parent;
    }

    /**
     * @param capacity - the capacity of the tank
     * @param validator - the filter, lambda expression that should return whether a fluid is allowed or not.

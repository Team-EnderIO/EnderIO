...
public class EIOTags {
    ...
    public static class Items {
        ...
        public static final TagKey<Item> DUSTS_ENDER = ItemTags.create(new ResourceLocation(ForgeVersion.MOD_ID, "dusts/ender_pearl"));
        ...
        public static final TagKey<Item> GEARS_IRON = ItemTags.create(new ResourceLocation(ForgeVersion.MOD_ID, "gears/iron"));

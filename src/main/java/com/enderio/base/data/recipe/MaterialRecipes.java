...
//            .save(recipeConsumer);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, EIOItems.CONDUIT_BINDER_COMPOSITE.get())
            .pattern("GCG")
            .pattern("SGS")
            .pattern("GCG")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, EIOItems.DYE_INDUSTRIAL_BLEND.get())
            .pattern("LQG")
            .pattern("QBQ")
            .pattern("GQL")
        ...
        SimpleCookingRecipeBuilder
            .smelting(Ingredient.of(EIOItems.CONDUIT_BINDER_COMPOSITE.get()), RecipeCategory.MISC, EIOItems.CONDUIT_BINDER.get(), 0, 100)

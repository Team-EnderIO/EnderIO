...
//            .save(recipeConsumer);
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(EIOItems.CONDUIT_BINDER_COMPOSITE.get()), EIOItems.CONDUIT_BINDER.get(), 0.0F, 200)
            .unlockedBy("has_ingredient", has(EIOItems.CONDUIT_BINDER_COMPOSITE.get()))
            .save(recipeConsumer);

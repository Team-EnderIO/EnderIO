...
public class ConduitItemFactory {
     ...
     */
    @Nullable
    private static BiFunction<IConduitType, Item.Properties, Item> factory = null;

    @ApiStatus.Internal
    public static void setFactory(BiFunction<IConduitType, Item.Properties, Item> factory) {
     ...
     * @return
     */
    public static Item build(IConduitType type, Item.Properties properties) {
        if (factory != null)

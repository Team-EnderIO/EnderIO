...
import com.enderio.api.conduit.ConduitNetworkContextAccessor;
...
public class ConduitGraphContext implements Mergeable<ConduitGraphContext>, ConduitNetworkContextAccessor {
    ...
    public CompoundTag save(HolderLookup.Provider lookupProvider) {
        ...
        var contextTypeKey = Objects.requireNonNull(EnderIORegistries.CONDUIT_NETWORK_CONTEXT_TYPE.getKey(context.type()), "Context type is not registered!");
    ...
    private static ConduitNetworkContext<?> loadNetworkContext(Conduit<?> conduit, HolderLookup.Provider lookupProvider, CompoundTag contextTag) {
        ...
        ConduitNetworkContextType<?> contextType = Objects.requireNonNull(EnderIORegistries.CONDUIT_NETWORK_CONTEXT_TYPE.get(serializerKey),

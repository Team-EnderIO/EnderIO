...
public class RedstoneXORFilter implements RedstoneInsertFilter{
    public static final Codec<RedstoneXORFilter> CODEC = RecordCodecBuilder.create(instance ->
        instance.group(ColorControl.CODEC.fieldOf("channel1").forGetter(r -> r.channel1),
            ...
            .apply(instance, RedstoneXORFilter::new)
    );
    public static final StreamCodec<ByteBuf, RedstoneXORFilter> STREAM_CODEC = StreamCodec.composite(
        ColorControl.STREAM_CODEC,
        r -> r.channel1,
        ColorControl.STREAM_CODEC,
        r -> r.channel2,
        RedstoneXORFilter::new
    );

    private final ColorControl channel1;
    private final ColorControl channel2;

    public RedstoneXORFilter(ColorControl channel1, ColorControl channel2) {
        this.channel1 = channel1;
        this.channel2 = channel2;
    }

    public RedstoneXORFilter() {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        RedstoneXORFilter that = (RedstoneXORFilter) o;

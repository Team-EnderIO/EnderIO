...
//
//    @Override
//    public ConduitTicker<AE2Conduit> getTicker() {
...
//
//    @Override
//    public void onConnectionsUpdated(ConduitNode node, Level level, BlockPos pos,
...
//    }
//
//    private static final class Ticker implements ConduitTicker<AE2Conduit> {
//
//        private static final Ticker INSTANCE = new Ticker();
//
//        @Override
//        public void tickGraph(ServerLevel level, AE2Conduit type, ConduitNetwork graph, ColoredRedstoneProvider coloredRedstoneProvider) {

...
public class Integrations {
    ...
    public static final IntegrationWrapper<MekanismIntegration> MEKANISM_INTEGRATION = IntegrationManager.wrapper(MekanismAPI.MEKANISM_MODID, MekanismIntegration::new, EnderIO.modEventBus);

...
//    private final Holder<AE2ConduitType> type;
//
//    @Nullable
//    private IManagedGridNode mainNode = null;
//
//    private AE2InWorldConduitNodeHost(AE2ConduitType type) {
//        this.type = type;
//    }
//
//    public static AE2InWorldConduitNodeHost create(AE2ConduitType type) {
//        var data = new AE2InWorldConduitNodeHost(type);
//        data.initMainNode();
//        return data;
//    }
//
//    private static AE2InWorldConduitNodeHost dummy(AE2ConduitType type) {
//        //noinspection unchecked
//        return new AE2InWorldConduitNodeHost(type);
//    }
//
//    private static AE2InWorldConduitNodeHost of(AE2ConduitType type, CompoundTag mainNodeTag) {
//        //noinspection unchecked
//        var data = new AE2InWorldConduitNodeHost(type);
//        data.initMainNode();
...
//                ConduitType.CODEC.fieldOf("conduit_type").forGetter(e -> e.type),

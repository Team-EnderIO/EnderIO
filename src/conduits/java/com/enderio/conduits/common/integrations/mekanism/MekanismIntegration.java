...
//
//    public static final DeferredRegister<ConduitType<?, ?, ?>> CONDUIT_NETWORK_TYPES = DeferredRegister.create(EnderIORegistries.CONDUIT_NETWORK_TYPES, EnderIO.MODID);
...
//    }
//
//    private static <T, U extends ConduitNetworkContext<U>, V extends ConduitData<V>, W extends ConduitType<T, U, V>> DeferredHolder<ConduitType<?, ?, ?>, ConduitType<T, U, V>> register(String name,
